...
parser = argparse.ArgumentParser(description="trying efficientnet-b0 with different shave num")
parser.add_argument("num_shaves", help="number of shaves")
...
nn.setBlobPath(Path("models/different shaves/efficientnet-b0_shave"+args.num_shaves+".blob"))
...
################################## warmup
cam = cv2.VideoCapture("../efficientnet/benchmark_224.mp4")
for _ in range(30):
    ret, frame = cam.read()
